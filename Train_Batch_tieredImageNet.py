...
"""
Author: Wenbin Li (liwenbin.nju@gmail.com or liwenbin@nju.edu.cn)
Date: Sep 16, 2020
Version: V0
...
from models import network_Wass, network_Wass_CMS, network_KL, network_KL_CMS, network_ADM
import utils
model_dict = dict(
					Wass     = network_Wass,
					Wass_CMS = network_Wass_CMS,
					KL       = network_KL,
					KL_CMS   = network_KL_CMS,
					ADM      = network_ADM) 
# ==================================================================================
...
parser.add_argument('--dataset_dir', default='/home/liwenbin/Datasets/tiered_imagenet', help='/miniImageNet')
parser.add_argument('--data_name', default='tieredImageNet', help='miniImageNet| tieredImageNet')
...
parser.add_argument('--outf', default='./results/tieredImageNet_NoDA_Test/')
...
parser.add_argument('--augment', action='store_true', default=False, help='Perform data augmentation or not')
